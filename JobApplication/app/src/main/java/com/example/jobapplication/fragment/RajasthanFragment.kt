...
class RajasthanFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
       ...
       val view= inflater.inflate(R.layout.fragment_rajasthan, container, false)

        userRecyclerView=view.findViewById(R.id.userlistr)
        ref = FirebaseDatabase.getInstance().getReference("Rajasthan")
