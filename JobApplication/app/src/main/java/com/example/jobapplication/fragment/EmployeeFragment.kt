...
class EmployeeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        userRecyclerView=view.findViewById(R.id.userlistee)
            ...
            override fun populateViewHolder(p0: ViewHolder?, p1: RetriveData?, p2: Int) {
                ...
                p0?.itemView?.findViewById<Button>(R.id.btnview)?.setOnClickListener {
                    ...
                    if (notEmpty()) {
                        ...
                        Toast.makeText(context, R.string.lbl_no_data_found, Toast.LENGTH_SHORT).show()
    ...
    private fun notEmpty(): Boolean =
       view?.findViewById<TextView>(R.id.txtcname)?.text.toString().isNotEmpty()
}