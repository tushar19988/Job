...
class MaharastraFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_maharastra, container, false)

        userRecyclerView = view.findViewById(R.id.userlistm)
        progressDialog =ProgressDialog(context)
        progressDialog!!.setCancelable(false)
        ref = FirebaseDatabase.getInstance().getReference("Maharastra")
